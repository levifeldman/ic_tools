...
final Icrc1Ledger _SNS1 = Icrc1Ledger(
    ...
    ledger: Canister(Principal.text('zfcdd-tqaaa-aaaaq-aaaga-cai')),
    index: Canister(Principal.text('zlaol-iaaaa-aaaaq-aaaha-cai'))
...
final Icrc1Ledger _ckBTC = Icrc1Ledger(
    ...
    decimals: 8,
    fee: BigInt.from(10),
    ledger: Canister(Principal.text('mxzaz-hqaaa-aaaar-qaada-cai')),
    index: Canister(Principal.text('n5wcd-faaaa-aaaar-qaaea-cai'))
);
final Icrc1Ledger _CHAT = Icrc1Ledger(
    ...
    ledger: Canister(Principal.text('2ouva-viaaa-aaaaq-aaamq-cai')),
    index: Canister(Principal.text('2awyi-oyaaa-aaaaq-aaanq-cai'))
);
...
class Tokens extends Nat {
    ...
    Tokens round_decimal_places(int round_decimal_places) {
        ...
        String decimal_places_split_at_round = decimal_places_string.substring(0, round_decimal_places);
        return Tokens.of_the_double_string('${tokens_string_split[0]}.${BigInt.parse(decimal_places_split_at_round)+BigInt.from(1)}', decimal_places: this.decimal_places);
    }
